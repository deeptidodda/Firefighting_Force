...
public class BasicScenarios {
    ...
    @Test
    public void simpleDoubleFireWithAssortedCityMultiple() throws FireproofBuildingException, NoFireFoundException {
        City basicCity = new CityImpl(5, 5, new CityNode(0, 0));
        FireDispatch fireDispatch = basicCity.getFireDispatch();
        ...
        firefighter = fireDispatch.getFirefighters().get(1);
        Assert.assertEquals(0, firefighter.distanceTraveled());
    }

    @Test
    public void simpleDoubleFireWithFireStationChange() throws FireproofBuildingException, NoFireFoundException {
        City basicCity = new CityImpl(5, 5, new CityNode(4, 4));
        FireDispatch fireDispatch = basicCity.getFireDispatch();
    ...
    @Test
    public void simpleDoubleFireWithAssortedCity() throws FireproofBuildingException, NoFireFoundException {
        City basicCity = new CityImpl(5, 5, new CityNode(0, 0));
        FireDispatch fireDispatch = basicCity.getFireDispatch();
